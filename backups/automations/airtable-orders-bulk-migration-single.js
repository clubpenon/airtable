// Airtable Automation Script - BULK MIGRATION (SINGLE RECORD)
// Trigger: Scheduled automation
// Action 1: Find records (all records from Orders table)
// Action 2: Repeating group - Run this script for each record
// Input: orderRecordId from the repeating group

// This script processes ONE Orders record at a time.
// It will be called repeatedly by Airtable's repeating group action.
