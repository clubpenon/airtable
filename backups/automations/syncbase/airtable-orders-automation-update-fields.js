// Airtable Automation Script - UPDATE FIELDS
// Trigger: When a record is updated in "Orders" table
// Watch fields: All mutable fields (Order Fulfillment Status, Order Payment Status, shipping fields, etc.)
// EXCLUDE: Order ID, Order Number, Product ID, Variant ID, Item ID, Customer ID, Quantity
// Action: Run this script

// This script updates the corresponding CP Orders record with the latest values.
...
// Extract Order ID to find the corresponding CP Order
...
// Find the corresponding CP Orders record
...
// Extract all mutable fields from the Orders record
